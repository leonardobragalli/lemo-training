...
const Modules = () => {
  ...
  const allLessons = [
    ...
    { id: 11, profile: 'pediatria',type: 'Video',   videoUrl: `${R2}/Accensione%20%26%20Stand-by%20-%20JR.mp4`, tl: tl[10] },
    { id: 3,  profile: 'adulti',   type: 'Video',    videoUrl: `${R2}/Posizionamento%20e%20ricarica.mp4`,    tl: tl[2] },
    { id: 12, profile: 'pediatria',type: 'Video',   videoUrl: `${R2}/Posizionare%20%2B%20Spie%20-%20Ok.mp4`, tl: tl[2] },
    ...
    { id: 13, profile: 'pediatria',type: 'Video',   videoUrl: `${R2}/Navigare%20tra%20le%20applicazioni%20Lemons.mp4`, tl: tl[11] },
  ...
  return (
    <motion.div initial={{ opacity: 1 }} animate={{ opacity: 1 }} exit={{ opacity: 1 }} className="px-6 pt-12 pb-6 md:px-10 md:pt-12 lg:px-12 lg:pt-12 2xl:p-16 2xl:pt-20 max-w-[1200px] 2xl:max-w-7xl mx-auto mb-20 md:mb-0 relative z-10 min-h-[100dvh]">
      ...
      {/* Backgrounds */}
      <div className="fixed inset-0 bg-cover bg-center z-[-30] bg-[url('/images/bg-mobile-modules.webp')] md:hidden opacity-30 dark:opacity-20 mix-blend-luminosity"></div>
      <div className="hidden md:block fixed inset-0 bg-cover bg-center z-[-30] bg-[url('/images/bg-modules.webp')] opacity-100"></div>
