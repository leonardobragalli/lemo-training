export const translations = {
  it: {
    ...
    support: {
      ...
      faqs: [
        { q: 'Quanto tempo serve per completare il programma di formazione?', a: "Il personale sanitario può completare l'intero percorso formativo in circa 10 minuti. È possibile comunque eseguire il percorso in momenti diversi senza perdere i progressi precedentemente raggiunti." },
        { q: "L'utilizzo del visore è sicuro?", a: "Sì, l'ecosistema Lemons in the room è progettato per essere utilizzato in totale sicurezza dai pazienti. Si consiglia di seguire sempre le linee guida cliniche del proprio reparto." },
        { q: 'La luce della base di ricarica lampeggia', a: "Se la luce della basetta di ricarica lampeggia, verificare che il visore sia posizionato correttamente sui pin magnetici. Nel caso in cui il posizionamento sia corretto e la luce continui a lampeggiare, assicurarsi che la spia di carica laterale sul visore sia accesa. Quando lo è, il visore sta caricando correttamente, nonostante la base di ricarica continui a lampeggiare." },
        { q: 'Il visore non si ricarica', a: "Verificare che il visore sia posizionato correttamente sui pin magnetici, controllare che i contatti metallici presenti sul visore e sulla base di ricarica siano puliti e assicurarsi che l'alimentatore sia inserito in una presa di corrente funzionante. Laddove il problema dovesse persistere, provare a ricaricare direttamente il visore con un cavo USB-C (può essere usato lo stesso cavo della base di ricarica) e nel caso in cui la spia di carica laterale sul visore non si accenda contattare l'assistenza clienti." },
        { q: 'Vedo lo scenario dell\'esperienza spostato', a: "Tieni premuto a lungo (circa 2-3 secondi) il tasto 'Oculus' (quello con il logo meta) sul controller destro, oppure unisci pollice e indice della mano destra, con il palmo della mano destra rivolto verso l'alto, e tieni premuto per ricentrare la visuale." },
        { q: 'Sento il suono ma non vedo niente', a: "Il sensore di prossimità (collocato tra le due lenti) potrebbe non rilevare il soggetto. Assicurarsi che il visore sia indossato correttamente e che non ci siano ostacoli davanti al sensore interno tra le due lenti (esempio: capelli). Nel caso in cui il problema dovesse persistere si consiglia di controllare la carica del visore e/o provare a spegnere e riaccendere il dispositivo." },
      ],
    },
  },
