export const translations = {
  it: {
    ...
    welcome: {
      ...
      firstName: 'Nome', lastName: 'Cognome', email: 'Email', hospital: 'Ospedale', department: 'Reparto',
      patientProfile: 'Profilo Paziente', pediatria: 'Pediatrico', adulti: 'Adulto',
      placeholderFirst: 'Mario', placeholderLast: 'Rossi', placeholderEmail: 'mario.rossi@ospedale.it', placeholderHospital: 'Es. Careggi', placeholderDept: 'Es. Oncologia',
  ...
  en: {
    ...
    welcome: {
      ...
      firstName: 'First Name', lastName: 'Last Name', email: 'Email', hospital: 'Hospital', department: 'Department',
      patientProfile: 'Patient Profile', pediatria: 'Pediatric', adulti: 'Adult',
      placeholderFirst: 'John', placeholderLast: 'Smith', placeholderEmail: 'john.smith@hospital.com', placeholderHospital: 'e.g. City Hospital', placeholderDept: 'e.g. Oncology',
  ...
  es: {
    ...
    welcome: {
      ...
      firstName: 'Nombre', lastName: 'Apellido', email: 'Email', hospital: 'Hospital', department: 'Departamento',
      patientProfile: 'Perfil del Paciente', pediatria: 'Pediátrico', adulti: 'Adulto',
      placeholderFirst: 'Juan', placeholderLast: 'García', placeholderEmail: 'juan.garcia@hospital.es', placeholderHospital: 'Ej. Hospital Central', placeholderDept: 'Ej. Oncología',
