  ...
  it: {
    ...
    support: {
      ...
      faqs: [
        ...
        { tag: 'Hardware',  q: 'Sento il suono ma non vedo niente', a: "Il sensore di prossimità (collocato tra le due lenti) potrebbe non rilevare il soggetto. Assicurarsi che il visore sia indossato correttamente e che non ci siano ostacoli davanti al sensore interno tra le due lenti (esempio: capelli). Nel caso in cui il problema dovesse persistere si consiglia di controllare la carica del visore e/o provare a spegnere e riaccendere il dispositivo." },
      ],
    },
  },
  ...
  en: {
    ...
    support: {
      ...
      faqs: [
        ...
        { tag: 'Hardware',  q: 'I hear the voice but see nothing', a: 'The proximity sensor may not be detecting your head. Make sure the headset is worn correctly and that there are no obstacles in front of the internal sensor between the two lenses.' },
      ],
    },
  },
  ...
  es: {
    ...
    support: {
      ...
      faqs: [
        ...
        { tag: 'Hardware',  q: 'Escucho la voz pero no veo nada', a: 'El sensor de proximidad puede no estar detectando la cabeza. Asegúrate de que el visor esté correctamente puesto y de que no haya obstáculos frente al sensor interno entre las dos lentes.' },
      ],
    },
  },
};
